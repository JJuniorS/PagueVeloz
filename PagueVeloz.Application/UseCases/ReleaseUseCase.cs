...
public class ReleaseUseCase
{
    ...
    public async Task ExecuteAsync(ReleaseRequest request)
    {
        ...
        using (await _lockManager.AcquireAsync(account.Id))
        {
            ...
            account.Release(request.Amount);
